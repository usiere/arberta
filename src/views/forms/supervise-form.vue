...
<div class="form-info" v-if="showForm">
  <h1 class="form-info-top">Request for Supervision:</h1>
...
<!-- End of the information -->
   ...
   <b-form-textarea
      id="textarea"
      v-model="message"
      placeholder="Brief description of the property intended to supervise"
      rows="3"
      max-rows="6"
    ></b-form-textarea>
    <br>
  ...
  data: function() {
   ...
   methods: {
      submit(){
        ...
        axios({
          method: 'post',
          url: 'http://localhost:3000/api/supervise',
          data:  client
        }).then(
