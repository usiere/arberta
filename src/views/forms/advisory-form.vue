...
<div class="form-info" v-if="showForm">
  <h1 class="form-info-top">Arberta Advisory:</h1>
...
<!-- End of the information -->
   ...
   <b-form-textarea
      id="textarea"
      v-model="message"
      placeholder=" Brief description of your area of need for Arberta advisory consultation"
      rows="3"
      max-rows="6"
    ></b-form-textarea>
    <br>
  ...
  data: function() {
   ...
   methods: {
      submit(){
        ...
        axios({
          method: 'post',
          url: 'http://localhost:3000/api/advise',
          data:  client
        }).then(
