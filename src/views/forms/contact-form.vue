...
<div class="form-info" v-if="showForm">
  <h1 class="form-info-top">Contact us  <font-awesome-icon :icon="['fas', 'envelope']" class="menu-icon" v-b-toggle.sidebar-1 /></h1>
    <h6 class="form-info-bottom"> NO 33 Noukchott street, Wuse zone1, Abuja.</h6>
